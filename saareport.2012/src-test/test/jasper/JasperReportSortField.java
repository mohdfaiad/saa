...
public class JasperReportSortField extends JFrame {
	...
	private void initialize() {
		...
		try{
		 report = JasperCompileManager.compileReport("C:/project/saa/src/saareport/report/templates/PN014.jrxml");
		}
		catch(Exception e){
		...
		if (button2 == null) {
			...
			button2.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					try{
						 report = JasperCompileManager.compileReport("C:/project/saa/src/saareport/bin/report/templates/PN014.jrxml");
						}
						catch(Exception ex){
