...
public class StackedBar3DChart extends Chart {
    ...
    public StackedBar3DChart() {
        ...
        setChartImage(new javax.swing.ImageIcon( getClass().getResource("/it/businesslogic/ireport/icons/charts/stackedbar3d_big.png")).getImage());
