...
public class XYZDatasetPanel extends javax.swing.JPanel implements ChartDatasetPanel {
    ...
    private XYZDataset xyzDataset = null;
    ...
    public void setXYZDataset(XYZDataset xyzDataset) {
        ...
        Vector v = xyzDataset.getXYZSeries();
    ...
    private void jMenuItemPasteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemPasteActionPerformed
        ...
        if (v != null && v.size() > 0)
        {
            for (int i=0; i<v.size(); ++i)
            {
                if (v.elementAt(i) instanceof XYZSeries)
                {
                    XYZSeries cs = (XYZSeries)v.elementAt(i);
                    cs = cs.cloneMe();
                    getXYZDataset().getXYZSeries().addElement(cs);
    ...
    private void jMenuItemCopyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCopyActionPerformed
        ...
        for (int i=0; i<values.length; ++i) copy_c.add( ((XYZSeries)values[i]).cloneMe() );
    ...
    private void jButtonModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModifyActionPerformed
        ...
        {
            XYZSeries cs = (XYZSeries)jList1.getSelectedValue();
            XYZSeriesDialog csd = new XYZSeriesDialog(it.businesslogic.ireport.gui.MainFrame.getMainInstance() ,true);
            ...
            csd.setZValueExpression( cs.getZValueExpression() );
    ...
    private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveActionPerformed
        ...
        {
            getXYZDataset().getXYZSeries().remove( jList1.getSelectedValue() );
