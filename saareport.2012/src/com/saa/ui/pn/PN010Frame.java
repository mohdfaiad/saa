 ...
 * @author aon
 * @since 13 Jan 2010
 * the very first report frame call to jdatasource instead of call
 */
public class PN010Frame extends BaseReportFrame{
...
//   protected String subReportName ="\\PNSUB002.jasper";
  ...
  // AppLogger log = AppLogger.getLogger(this.getClass().getName());
   ...
   public  PN010Frame(SubTreeObject node , int w , int h){
      super(node,w,h);
