 ...
 */
public class XYDatasetPanel extends javax.swing.JPanel  implements ChartDatasetPanel  {
    ...
    {
            for (int i=0; i<xyDataset.getXYSeries().size(); ++i)
            {
                Object series = xyDataset.getXYSeries().elementAt(i);
                ((javax.swing.DefaultListModel)jList1.getModel()).removeElement(series);
                 xyDataset.getXYSeries().removeElementAt(i);
                 i--;
            }
            jList1.updateUI();
    }
    ...
    private void jMenuItemPasteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemPasteActionPerformed
        ...
        if (v != null && v.size() > 0)
        {
            for (int i=0; i<v.size(); ++i)
            {
                    ...
                    cs = cs.cloneMe();
                    getXYDataset().getXYSeries().addElement(cs);
    ...
    private void jButtonModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModifyActionPerformed
        ...
        if (jList1.getSelectedIndex() >= 0)
        {
                ...
                XYSeries cs = (XYSeries)jList1.getSelectedValue();
                XYSeriesDialog csd = new XYSeriesDialog(it.businesslogic.ireport.gui.MainFrame.getMainInstance() ,true);
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
            ...
            if (csd.getDialogResult() == javax.swing.JOptionPane.OK_OPTION)
            {
                ...
                xyDataset.getXYSeries().addElement(cs);
                ((javax.swing.DefaultListModel)jList1.getModel()).addElement(cs);
                jList1.updateUI();
            }
    ...
    private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveActionPerformed
        ...
        {
            xyDataset.getXYSeries().remove( jList1.getSelectedValue() );
     ...
     public void applyI18n()
    {
                ...
                jMenuItemPaste.setText(I18n.getString("xYDatasetPanel.menuItemPaste","Paste series"));
