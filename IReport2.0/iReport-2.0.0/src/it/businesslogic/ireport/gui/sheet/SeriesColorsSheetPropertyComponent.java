 ...
 *
 *
 * SeriesColorsSheetPropertyComponent.java
 * 
 ...
 */
public class SeriesColorsSheetPropertyComponent extends javax.swing.JPanel {
    
    private java.util.List listOfSeriesColor = new java.util.ArrayList();
    ...
    public SeriesColorsSheetPropertyComponent() {
        ...
        applyI18n();
        setListOfSeriesColor(listOfSeriesColor);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SeriesColorsDialog dialog = null;
        Window topLevel = SwingUtilities.getWindowAncestor(this);
 
        if (topLevel == null)
        {
            dialog = new SeriesColorsDialog((Frame)null,true);
        }
        else if (topLevel instanceof Frame) {
            dialog = new SeriesColorsDialog((Frame)topLevel, true);
        }
        else if (topLevel instanceof Dialog) {
            dialog = new SeriesColorsDialog((Dialog)topLevel, true);
        }
        
        dialog.setSeriescolors( listOfSeriesColor );
        dialog.setVisible(true);
        
        if (dialog.getDialogResult() == JOptionPane.OK_OPTION)
        {
            this.setListOfSeriesColor( dialog.getSeriescolors() );
    ...
    public java.util.List getListOfSeriesColor() {
        return listOfSeriesColor;
    }

    public void setListOfSeriesColor(java.util.List listOfSeriesColor) {
        
        if (listOfSeriesColor == null || !(listOfSeriesColor instanceof List)) return;
        
        this.listOfSeriesColor = listOfSeriesColor;
        ...
        {
            SeriesColor sc = (SeriesColor)listOfSeriesColor.get(i);
            ...
            panel.setBackground( sc.getColor() );
