 ...
 *
 *
 * FormatCommandIncreaseSpaceV.java
 * 
 ...
 *
 */
public class FormatCommandIncreaseSpaceV extends FormatCommand {
    {
        operationType = OperationType.INCREASE_SPACE_V;
    }
    ...
    public void modify() {
        ...
        re.setPosition(new Point(re.getPosition().x,
                re.getPosition().y + 5 * (getCurrentElementPosition()+1)
                ));
    }
