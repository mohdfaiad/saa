...
public class BandsDialog extends javax.swing.JDialog implements ReportListener {
	...
	if (delta != 0)
	{
                ...
                if (!b.getName().equals("background") &&
                    !( b.getName().equals("title") && report.isIsTitleNewPage()) &&
                    !( b.getName().equals("summary") &&report.isIsSummaryNewPage()))
                {
                    for (int i=0; i<report.getBands().size(); ++i)
                    {
                        ...
                        if (!(aBand.getName().equals("background")) &&
                            !(aBand.getName().equals("title") && report.isIsTitleNewPage()) &&
                            !(aBand.getName().equals("summary") && report.isIsSummaryNewPage()) &&
                            !(aBand == b))
                        {
