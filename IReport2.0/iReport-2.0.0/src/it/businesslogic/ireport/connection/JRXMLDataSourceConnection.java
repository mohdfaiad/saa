...
import it.businesslogic.ireport.connection.gui.JRXMLDataSourceConnectionEditor;
...
public class JRXMLDataSourceConnection extends it.businesslogic.ireport.IReportConnection {
    ...
    public void setTimeZone(TimeZone timeZone) {
     ...
     public String getDescription(){ return I18n.getString("connectionType.xml", "XML file datasource"); }
            ...
            try {
                ...
                if (!f.exists())
                {
                    JOptionPane.showMessageDialog(MainFrame.getMainInstance(),
                            I18n.getFormattedString("messages.connectionDialog.fileNotFound","File {0} not found", new Object[]{this.getFilename()}),
