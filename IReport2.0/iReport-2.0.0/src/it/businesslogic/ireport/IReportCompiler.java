         ...
         if (print != null)
         {
            ...
            try
            {
               ...
               else if (format.equalsIgnoreCase("xls2"))
               {
                  ...
                  { exporter.setParameter( JExcelApiExporterParameter.IS_FONT_SIZE_FIX_ENABLED, new Boolean( this.getMainFrame().getProperties().getProperty("XLS2_IS_FONT_SIZE_FIX_ENABLED")) ); }
