inherited StockEnquriyDM: TStockEnquriyDM
  OldCreateOrder = True
  Left = 287
  Top = 268
  Height = 484
  ...
  object qryPurchaseDetail: TIBQuery
    Database = WarehouseDataManager.IBDatabase
    Transaction = WarehouseDataManager.IBTransaction
    OnCalcFields = qryPurchaseDetailCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
    ...
    object qryPurchaseDetailCalTotalCost: TFloatField
      DisplayLabel = 'Total Cost'
      DisplayWidth = 10
      FieldKind = fkCalculated
      FieldName = 'CalTotalCost'
      Calculated = True
    end
  ...
  object qryOnhand: TIBQuery
    Database = WarehouseDataManager.IBDatabase
    Transaction = WarehouseDataManager.IBTransaction
    OnCalcFields = qryOnhandCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
    ...
    object qryOnhandcalTotalCost: TFloatField
      DisplayLabel = 'Total Cost'
      DisplayWidth = 10
      FieldKind = fkCalculated
      FieldName = 'calTotalCost'
  ...
  object qryPurchaseHeader: TIBQuery
    ...
    SQL.Strings = (
      'select po_order_hd.order_no,'
        ...
        '        po_order_hd.order_date,po_order_hd.delivery_date,po_orde' +
        'r_hd.supp_code,name ,ic_mat_stk_dt_link.onhand_qty,'
      
        '        ic_mat_stk_dt_link.reserved_qty,ic_mat_stk_dt_link.unit_' +
        'cost  ,ic_mat_stk_hd.en_descs as item_descs'
      
        '        from PO_ORDER_HD ,PO_SUPPLIER    , po_order_dt ,ic_mat_s' +
        'tk_hd   , ic_mat_stk_dt_link'
      ...
      '         and po_order_dt.item_code = ic_mat_stk_dt_link.stock_cd'
      
        '         and po_order_dt.order_date = ic_mat_stk_dt_link.purchas' +
        'e_date'
      '         and po_order_dt.order_no = ic_mat_stk_dt_link.lot_cd'
    ...
    object qryPurchaseHeaderITEM_DESCS: TIBStringField
      DisplayLabel = 'Stock Description'
      DisplayWidth = 30
      FieldName = 'ITEM_DESCS'
    ...
    object qryPurchaseHeaderONHAND_QTY: TFloatField
      DisplayLabel = 'ONHAND QTY'
      DisplayWidth = 11
      FieldName = 'ONHAND_QTY'
      Origin = 'IC_MAT_STK_DT_LINK.ONHAND_QTY'
    ...
    object qryPurchaseHeaderRESERVED_QTY: TFloatField
      DisplayLabel = 'RESERVED QTY'
      DisplayWidth = 14
      FieldName = 'RESERVED_QTY'
      Origin = 'IC_MAT_STK_DT_LINK.RESERVED_QTY'
    ...
    object qryPurchaseHeaderUNIT_COST: TFloatField
      DisplayLabel = 'UNIT COST'
      DisplayWidth = 13
      FieldName = 'UNIT_COST'
      Origin = 'IC_MAT_STK_DT_LINK.UNIT_COST'
