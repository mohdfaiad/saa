...
type
  TStockAdjustDataModule = class(TAbstractDM)
    ...
    qryOnhandDetailSTOCK_CD: TIBStringField;
    qryOnhandDetailGROUP_ID: TIBStringField;
    qryOnhandDetailUOM_CD: TIBStringField;
    qryOnhandDetailLOT_CD: TIBStringField;
    qryOnhandDetailUNIT_COST: TFloatField;
    qryOnhandDetailLAST_PURCHASE_PRICE: TFloatField;
    qryOnhandDetailPURCHASE_DATE: TDateTimeField;
    qryOnhandDetailONHAND_QTY: TFloatField;
    qryOnhandDetailRESERVED_QTY: TFloatField;
    qryOnhandDetailSTOCK_VALUE: TFloatField;
    qryOnhandDetailTOTAL_COST: TFloatField;
    qryOnhandDetailACCT_CODE: TIBStringField;
    qryOnhandDetailORDER_LINE: TSmallintField;
...
' where  purchase_date >= current_date - '+IntToStr(SystemConfigure.readIntRegistry('LastPurchaseDays')) +
