...
type
  TStockEnquriyDM = class(TAbstractDM)
    ...
    qryPurchaseDetailCalTotalCost: TFloatField;
    qryOnhandcalTotalCost: TFloatField;
    tbSupplier: TIBTable;
    tbSupplierSUPPLIER_CD: TIBStringField;
    tbSupplierNAME: TIBStringField;
    qryPurchaseHeaderONHAND_QTY: TFloatField;
    qryPurchaseHeaderRESERVED_QTY: TFloatField;
    qryPurchaseHeaderUNIT_COST: TFloatField;
    qryPurchaseHeaderITEM_DESCS: TIBStringField;
    procedure qryPurchaseHeaderAfterScroll(DataSet: TDataSet);
    procedure DataModuleCreate(Sender: TObject);
    procedure qryPurchaseDetailCalcFields(DataSet: TDataSet);
    procedure qryOnhandCalcFields(DataSet: TDataSet); {#### main query call####}
  private
...
procedure TStockEnquriyDM.qryPurchaseDetailCalcFields(DataSet: TDataSet);
begin
qryPurchaseDetailCalTotalCost.AsFloat :=  qryPurchaseDetailGRN_QTY.AsFloat * qryPurchaseDetailUNIT_COST.AsFloat;

end;

procedure TStockEnquriyDM.qryOnhandCalcFields(DataSet: TDataSet);
begin
  qryOnhandcalTotalCost.AsFloat := qryOnhandONHAND_QTY.AsFloat* qryOnhandUNIT_COST.AsFloat;
