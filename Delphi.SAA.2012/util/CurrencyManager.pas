...
If Value = '6' Then BahtStang :='??';
If Value = '7' Then BahtStang :='????';
If Value = '8' Then BahtStang :='???';
...
begin
Case Position Of
7,13,19,25 : BahtStang := BahtStang+'????';
6,12,18,24 : BahtStang := BahtStang+'???';
5,11,17,23 : BahtStang := BahtStang+'?????';
4,10,16,22 : BahtStang := BahtStang+'???';
3,9,15,21 : BahtStang := BahtStang+'????';
2,8,14,20 : BahtStang := BahtStang+'???';
end
end
else
If (Position = 7) Or
...
begin
If (DecimalCh1 = '0') Or (Decim 
???: [0 3] ( IP )  

--------------------------------------------------------------------------------
?????????????? 2
   alCh1 = '1') Or (DecimalCh1 = '2') Then
begin
...
If DecimalCh2 = '2' Then ThaiStang := ThaiStang+'???';
end
else
